...
const MenuListSellers = ({ sellersList, getDetailsSellerById }: { sellersList: ISellers[], getDetailsSellerById: (id_seller: number) => void }) => {
    return (
        ...
        <div className='Flex flex-col'>
            ...
            <ul className='flex flex-col gap-y-2 pt-6 p-2'>
                ...
                {sellersList.map((seller) => (
                    <li
                        key={seller.id}
                        onClick={() => { getDetailsSellerById(Number(seller.id)) }}
